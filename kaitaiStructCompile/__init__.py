...
from .ICompiler import ICompiler as CompilerClass, PostprocessResult, ICompileResult

def compile(ksyFiles: typing.Union[Path, str, typing.Iterable[Path]], outputDir: Path = None, progressCallback=None, dirs=None, additionalFlags: typing.Tuple[str]=(), namespaces=None, backend: typing.Optional[typing.Type[CompilerClass]] = None, **kwargs) -> typing.Dict[str, ICompileResult]:
